...
<body style="background-color:lightblue;">
	...
	<section >
		...
		<div id="fom">
			...
			<h3 style="text-align:center; color: #000099; font-weight:bold; text-decoration:underline">Seller Login Area</h3>
  ...
  <button type="submit" class="btn btn-default" name="log">Submit</button> <a href="signup.php">Sigup Here</a>
			...
			<?php
				if(isset($_POST['log'])){
					...
					$qy = "SELECT * FROM seller WHERE email = '$uname' AND id_no = '$pass'";
					$log = $conn->query($qy);
					$num = $log->num_rows;
					$row = $log->fetch_assoc();
					if($num > 0){
