	...
	<section class="">
		...
		?>
			...
			<section class="caption">
				<h2 class="caption" style="text-align: center;color:grey">Find You Dream Cars For Hire</h2>
	...
	<section class="listings">
		<div class="wrapper">
			...
			<?php
						...
						$sel = "SELECT * FROM caradd WHERE status = 'Approved'";
						$rs = $conn->query($sel);
			...
			?>
				<li>
					...
					<div class="property_details">
						<h1>
							<a href="book_car.php?id=<?php echo $rws['car_id'] ?>"><?php echo 'Car Make>'.$rws['ctype'];?></a>
						</h1>
						<h2>Car Name/Model: <span class="property_size"><?php echo $rws['cname'];?></span></h2>
					</div>
				</li>
			<?php
				}
