...
<head>
	...
	<script type="text/javascript">
		function sureToApprove(id){
			...
			if(confirm("Are you sure you want to reply this message?")){
				window.location.href ='reply_msg.php?id='+id;
			}
		}
	</script>
</head>
					...
					<div class="table">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
                             ...
                             <a href="javascript:sureToApprove2(<?php echo $row['msg_id'];?>)" class="ico edit">Edit</a></td>
							</tr>
							<?php
								}
							?>
